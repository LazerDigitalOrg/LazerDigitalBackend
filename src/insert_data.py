    ...
    try:
        async with session.begin():
            ...
            brands = [
                ...
                Brand(title="Vari-Lite", description="Лидер в своей области"),
                Brand(title="Chroma-Q", description="Лидер в своей области"),
                Brand(title="Griven", description="Лидер в своей области"),
                Brand(title="Griven", description="Лидер в своей области")
            ...
            equipments = [
                ...
                Equipment(
                    ...
                    characteristics={"Производитель": "Clay Paky / Италия", "Тип прибора": "WASH",
                                     "Кол-во источников света": 1, "Цветовая температура": "7600K",
                                     "Угол Вращения PAN": "540°", "Угол Вращения TILT": " 210°",
                                     "Мощность": "110 Вт",
                                     "Яркость": "1800 лм", "Угол раскрытия луча:": "4°-60°",
                                     "Цветовая схема": "RGBW"},
                    weight=12,
                    available_quantity=10,
                ...
                Equipment(
                    ...
                    characteristics={"Производитель": "Martin / Дания", "Яркость": "26000 Лм",
                ...
                Equipment(
                    ...
                    power="1200 Вт",
                    producer="Martin / Дания",
                    characteristics={"Производитель": "Martin / Дания", "Мощность": "1500 Вт",
                                     "Яркость": "33900 лм",
                ...
                Equipment(
                    ...
                    power="1200 Вт",
                    producer="Martin/Дания",
                    characteristics={"Производитель": "Martin / Дания", "Мощность": "1200 Вт",
                                     "Яркость": "33900 лм",
                ...
                Equipment(
                    ...
                    category_slug="0-moving-heads",
                    power="470 Вт",
                    producer="Clay Paky / Италия",
                    characteristics={"Производитель": "Martin / Дания", "Мощность": "470  Вт",
                                     "Яркость": "23000 лм",
                                     "Zoom": "0°-4°", "Цветовая система": "колесо 14 цветов",
                                     "Освещение": "20 гобо"},
                    description="""Super Sharpy - продолжение линейки световых приборов типа Beam от итальянского производителя Clay Paky. Новый прибор имеет 4-ех кратное преимущество по перед Sharpy выходу света. Прибор использует лампу мощностью 470 Вт, что необычайно мало для такой яркости. Это делает Super Sharpy самым ярким низкомощным прожектором. Super Sharpy предоставляется в аренду с всепогодным защитным куполом Clay Paky Igloo.Суммируя преимущества Super Sharpy: всепогодный, яркий, маломощный и имеет встроенные эффекты, можно заключить, что этот световой прибор подойдет для уличных мероприятий любых масштабов в качестве качественного beam прибора или небесного прожектора.Компания Лазер-Кинетикс начиная с июня 2015 года может предоставить необходимо количество световых приборов Super Sharpy в прокат или аренду.""",
                    weight=8,
                    available_quantity=10,
                    photo_url="https://laserkinetics.ru/uploadedFiles/eshopimages/icons/340x340_cropped/1_2.jpg",
                    quantity=10
                ),
                Equipment(
                    title="Mythos",
                    ...
                    power="1200 Вт",
                    producer="Martin/Дания",
                    characteristics={"Производитель": "Clay-Paky / Италия", "Мощность": "1200 Вт",
                                     "Яркость": "23000 лм",
                                     "Zoom": "2.5°, 4°-31°, 6.7°-50°",

                                     "Цветовая система": " колесо 14 цветов", "Освещение": "20 гобо"},
                    weight=8,
                    available_quantity=10,
                    photo_url="https://laserkinetics.ru/uploadedFiles/eshopimages/icons/340x340_cropped/1_3.jpg",
                    quantity=10
                ),
                Equipment(
                    title="Sharpy Beam",
                    ...
                    power="189 Вт",
                    producer="Clay-Paky / Италия",
                    characteristics={"Производитель": "Clay-Paky / Италия", "Мощность": "189 Вт",
                                     "Яркость": " 7940 лм",
                                     "Zoom": "0°-3.8°", "Освещение": "17 гобо", "Фильтр": "Frost"},
                    weight=8,
                    description="Sharpy – это световой прибор полного вращения мощностью в 189 Вт. Прибор обеспечивает световой луч невероятной яркости и чистоты. Его края четко очерчены и без каких либо искажений на границах луча. 14 разных цветов и 17 гобо позволяют получит луч любой формы и создавать необходимую световую картинку.",
                    available_quantity=10,
                    photo_url="https://laserkinetics.ru/uploadedFiles/eshopimages/icons/340x340_cropped/1_4.jpg",
                    quantity=10
                ),
                Equipment(
                    title="Mac Quantum Wash",
                    rental_price=12000,
                    ...
                    power="189 Вт",
                    producer="Clay-Paky / Италия",
                    characteristics={"Производитель": "Martin / Дания", "Мощность": "189 Вт",
                                     "Яркость": " до 15700 лм",
                                     "Zoom": "11°- 52°", "Цветовая температура": "2000 - 10000 К",
                                     "Цветовая система": "RGBW"},
                    weight=8,
                    description="В MAC Quantum присутствует целый спектр разнообразных возможностей: узкий луч, эффект заливки, богатейшая палитра цветовых оттенков, однородный цветосинтез. Этот прибор подойдет для решения множества ярких и креативных задач в любых проектах. Светодиодный RGBW массив мощностью 750 Вт в комбинации с лучшей оптической системой от Martin гарантирует MAC Quantum с зумом 1:6 максимально возможный световой выход и высокое качество эффектов.",
                    available_quantity=10,
                    photo_url="https://laserkinetics.ru/uploadedFiles/eshopimages/icons/340x340_cropped/1_3.png",
                    quantity=10
                ),
                Equipment(
                    title="Mac Aura LED",
                    ...
                    power="260 Вт",
                    producer="Martin / Дания",
                    characteristics={"Производитель": "Martin / Дания", "Мощность": "260 Вт", "Яркость": "3850  лм",
                                     "Общая мощность": "260 Вт",
                                     "Zoom": "11° - 58°", "Цветовая система": "RGB"},
                    weight=8,
                    description="Martin Professional представляет первый компактный светодиодный прибор заливки с зумом, демонстрирующий совершенно новые, ранее неизвестные световые эффекты ауры - MAC Aura. В отличие от многих других аналогов, в этом устройстве установлена единая линза, а смешение оттенков происходит до попадания потока на световыводящую поверхность.",
                    available_quantity=10,
                    photo_url="https://laserkinetics.ru/uploadedFiles/eshopimages/icons/340x340_cropped/1_4.png",
                    quantity=10
                ),
                Equipment(
                    title="Showgun",
                    ...
                    category_slug="0-moving-heads",
                    power="2800 Вт",
                    producer="Vari-Lite / США",
                    characteristics={"Производитель": "Vari-Lite / США", "Мощность": "700 Вт",
                                     "Общая мощность": "700 Вт",
                                     "Яркость": "15000 лм",
                                     "Zoom": "19° - 36°", "Цветовая система": "CMY"},
                    weight=8,
                    description="""Световой прибор от Vari-Lite, обладая идеальной цветовой температурой, нашел широкое применение в телевизионных съемках. VL 1000 AS обладает повышенной яркостью и широким зумом. С функцией "супер зум" есть возможность раскрывать луч прибора на угол до 70°. Компания Лазер-Кинетикс имеет в своем парке большое колечество Vari-Lite VL 1000 AS и предоставляет необходимое количествого этих световых приборов для мероприятий любого масштаба.""",
                    available_quantity=10,
                    photo_url="https://laserkinetics.ru/uploadedFiles/eshopimages/icons/340x340_cropped/1_6.png",
                    quantity=10
                ),
                Equipment(
                    title="Vari-Lite VL 1000 AS",
                    rental_price=12000,
                    brand_id=brands[15].id,
                    category_id=categories[0].id,
                    category_slug="0-moving-heads",
                    power="700 Вт",
                    producer="Vari-Lite / США",
                ...
                Equipment(
                    ...
                    power="700 Вт",
                    producer="Martin / Дания",
                    characteristics={"Производитель": "Martin / Дания", "Мощность": "700 Вт",
                                     "Общая мощность": "700 Вт",
                                     "Яркость": "18700 лм", "Цветовая температура": "7500K",
                                     "Zoom": "12° - 66°", "Цветовая система": "CMY"},
                    weight=8,
                    description="MAC 700 Profile — мощный компактный световой прибор с великолепной цветопередачей и первоклассной оптической системой, чем выгодно отличается от своих ближайших конкурентов. Он обладает широкодиапазонным синтезом CMY, к этому надо добавить 8 светофильтров, а также анимацию гобо для создания невероятных проекций. Помимо этого устройство оснащено диафрагмой, вращающимися гобо и системой масштабирования.",
                    available_quantity=10,
                    photo_url="https://laserkinetics.ru/uploadedFiles/eshopimages/icons/340x340_cropped/1_9.png",
                    quantity=10
                ),
                Equipment(
                    title="Mac 700 Profile",
                    rental_price=12000,
                    brand_id=brands[2].id,
                    category_id=categories[0].id,
                    category_slug="0-moving-heads",
                    ...
                    characteristics={"Производитель": "Martin / Дания", "Мощность": "700 Вт",
                                     "Общая мощность": "700 Вт",
                                     "Яркость": "14700 лм", "Цветовая температура": "7500K",
                                     "Zoom": "16° - 66°", "Цветовая система": "CMY"},
                    weight=8,
                    description="MAC 700 Profile — мощный компактный световой прибор с великолепной цветопередачей и первоклассной оптической системой, чем выгодно отличается от своих ближайших конкурентов. Он обладает широкодиапазонным синтезом CMY, к этому надо добавить 8 светофильтров, а также анимацию гобо для создания невероятных проекций. Помимо этого устройство оснащено диафрагмой, вращающимися гобо и системой масштабирования.",
                    available_quantity=10,
                    photo_url="https://laserkinetics.ru/uploadedFiles/eshopimages/icons/340x340_cropped/1_10.png",
                    quantity=10
                ),
                ...
                Equipment(
                    ...
                    power="550 Вт",
                    producer="GLP / Германия",
                    characteristics={"Производитель": "GLP / Германия", "Мощность": "1200 Вт",
                                     "Общая мощность": "1200 Вт",
                                     "Тип прибора": "Диоды",
                                     "Количество диодов": "1230",
                                     },
                    description="""GLP impression JDC1 - Прибор, который вы раньше не видели. JDC1 работает как классический трубный прибор, но за счет мощных светодиодов, дающих яркий и чистый белый свет. Помимо этого JDC1 имеет дополнительные RGB светодиоды расположенные по обоим сторонам от центрального элемента. Белые и цветные пиксели независимы друг от друга и могут работать как вместе, так и по отдельности, открывая широкий простор для украшения любого шоу. Для повышения функциональности и белые и цветные диоды можно разбить на 12 независимых «кластеров» и управлять ими отдельно. JDC1 обладает моротизированным углом поворота с 16-битным диапозоном наклона в 185°, позволяя добиться нужного эффекта где и когда вы хотите.""",
                    weight=12,
                    available_quantity=10,
                    photo_url="https://laserkinetics.ru/uploadedFiles/eshopimages/icons/340x340_cropped/jdc1-2.png",
                    quantity=10
                ),
                Equipment(
                    title="Atomic 3000",
                ...
                Equipment(
                    ...
                    power="60 Вт",
                    producer="Chroma-Q / США",
                    characteristics={"Производитель": "Chroma-Q / США", "Мощность": "60 Вт",
                                     "Общая мощность": "60 Вт",
                                     "Zoom": "25°",
                                     "Яроксть": "530 лм",
                                     "Цветовая система": "RGB+A",
                                     },
                    description="""Color block 2 – это модульный светодиодный прибор для заливки светом. Из таких модулей возможно собирать различные конструкции под любые осветительные нужды.""",
                    weight=12,
                    available_quantity=10,
                    photo_url="https://laserkinetics.ru/uploadedFiles/eshopimages/icons/340x340_cropped/02_23.png",
                    quantity=10
                ),
                Equipment(
                    title="Kolorado",
                    rental_price=5000,
                    brand_id=brands[17].id,
                    category_id=categories[4].id,
                    category_slug="4-etc-light",
                    power="5000 Вт",
                    producer="Griven / Италия",
                    characteristics={"Производитель": "Griven / Италия", "Мощность": "5000 Вт",
                                     "Общая мощность": "5000 Вт",
                                     },
                    description="""Световой прибор Kolorado предназначен для архитектурной подсветки. Обладает мощной лампой 2500 Вт и системой смены цвета CMY. Оптическая система и 4 шторки этого прибора позволяют настраивать световой луч и освещать большие поверхности. Kolorado демонстрирует себя как отличный световой прибор для работы во всепогодных условиях.""",
                    weight=12,
                    available_quantity=10,
                    photo_url="https://laserkinetics.ru/uploadedFiles/eshopimages/icons/340x340_cropped/02_24.png",
                    quantity=10
                ),
                Equipment(
                    title="Par-lite 56 LED",
                    rental_price=5000,
                    brand_id=brands[18].id,
                    category_id=categories[4].id,
                    category_slug="4-etc-light",
                    power="650 Вт",
                    producer="Coemar / Италия",
                    characteristics={"Производитель": "Coemar / Италия", "Мощность": "650 Вт",
                                     "Общая мощность": "650 Вт",
                                     "Яркость": "530 Лм",
                                     "Цветовая система": "RGB",
                                     "Zoom": "12°"
                                     },
                    description="""Идеальный диодный прибор для заливки светом. Специальная энергосберегающая технология позволяет экономить до 82% энергии по сравнению с традиционной технологией той же яркости.""",
                    weight=12,
                    available_quantity=10,
                    photo_url="https://laserkinetics.ru/uploadedFiles/eshopimages/icons/340x340_cropped/02_25.png",
                    quantity=10
                ),
                Equipment(
                    title="Color Force 48",
                ...
                Equipment(
                    ...
                    characteristics={"Производитель": "MA Lighting / Германия",
                                     "Технические характеристики": [
                                         "6 выходов DMX", "1 встроенный программируемый экран",
                ...
                Equipment(
                    ...
                    characteristics={"Производитель": "High End Systems / США",
                                     "Технические характеристики": [
                                         "2 Ethernet порта", "2 сенсерных экрана",
                ...
                Equipment(
                    title="Grand MA 2 Full Size",
                    rental_price=20000,
                    brand_id=brands[7].id,
                    category_id=categories[2].id,
                    category_slug="2-consoles",
                    producer="MA Lighting / Германия",
                    characteristics={"Производитель": "MA Lighting / Германия", "Технические характеристики": [
                        "6 выходов DMX",
                        "3 встроенных монитора",
                        "2 внешних монитора",
                        "30 приводных фейдеров",
                        "2 входе etherCON",
                        "Встроенная клавиатура",
                    ]},
                    weight=12,
                    description="""MA 2 Full-size – это самая мощная консоль для управления стационарным и динамичным светом, LED приборами и медийным оборудованием в одном корпусе.""",
                    available_quantity=12,
                    photo_url="https://laserkinetics.ru/uploadedFiles/eshopimages/icons/340x340_cropped/02_13.png",
                    quantity=8
                ),
                Equipment(
                    title="Световой пульт M6",
                    rental_price=20000,
                    brand_id=brands[2].id,
                    category_id=categories[2].id,
                    category_slug="2-consoles",
                    producer="Martin / Дания",
                    characteristics={"Производитель": "Martin / Дания", "Технические характеристики": [
                        "2 мульти-сенсерных экрана",
                        "10 приводных фейдеров",
                        "2 широкоэкранных монитора BriteTouch",
                        "2 экрана FastTouch, 3,5-дюйма",
                        "12 мастеров Sub Playback",
                        '10 моторизованных мастеров с ЖК дисплеем',
                        "12 вращающихся энкодеров FastDial"
                    ]}, weight=12,
                    description="""Martin Professional представляет M6 - новую консоль для управления визуальными эффектами, созданную по последнему слову техники и с прицелом на большое будущее.Разрабатывая этот пульт, главной задачей было предложить пользователям инструмент, который позволит им одновременно работать и с традиционными световыми приборами, и с приборами с полным вращением, а также с самыми современными медиа-серверами. M6 окажет полноценную поддержку на любом современном комплексном мультимедийном шоу, кроме того он обладает достаточным потенциалом, чтобы ответить на будущие изменения, связанные с развитием индустрии шоу-проектов.""",
                    available_quantity=12,
                    photo_url="https://laserkinetics.ru/uploadedFiles/eshopimages/icons/340x340_cropped/02_14.png",
                    quantity=8
                ),
                Equipment(
                    ...
                    category_slug=nested_categories[0].parent_category_slug + "/" + nested_categories[
                        0].category_slug,
                    characteristics={
                        "Технические характеристики": ["Различные модели", "Различные длины и радиусы"]},
                    weight=0,
                    available_quantity=12,
                ...
                Equipment(
                    ...
                    rental_price=0,
                    category_slug=nested_categories[1].parent_category_slug + "/" + nested_categories[
                        1].category_slug,
                ...
                Equipment(
                    ...
                    category_slug=nested_categories[3].parent_category_slug + "/" + nested_categories[
                        3].category_slug,
                ...
                Equipment(
                    ...
                    category_slug=nested_categories[4].parent_category_slug + "/" + nested_categories[
                        4].category_slug,
                ...
                Equipment(
                    ...
                    rental_price=0,
                    category_slug=nested_categories[5].parent_category_slug + "/" + nested_categories[
                        5].category_slug,
            ...
            events = [
                ...
                Event(
                    ...
                    event_end_date=datetime(2025, 3, 15, 22),
                ...
                Event(
                    ...
                    event_end_date=datetime(2025, 4, 17, 22),
                    type=EventTypeEnum.WEDDING,
                    status=EventStatusEnum.ARCHIVE,
                    area_plan=b"dummy_binary_data_plan3",
                    title="Кипелов на ВТБ Арене",
                    address="Exhibition Hall, Downtown",
                    payment_method=PaymentMethod.LLL,
                    comment="Art exhibition opening",
                    site_area=500,
